...
-- NOTA: Si alguna columna ya existe, ignorar el error
-- =====================================================

-- Agregar email
ALTER TABLE funcionarios 
ADD COLUMN email VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'Email del funcionario';

-- Agregar email_jefe_inmediato
ALTER TABLE funcionarios 
ADD COLUMN email_jefe_inmediato VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'Email del jefe inmediato';

-- Agregar email_revisor
ALTER TABLE funcionarios 
ADD COLUMN email_revisor VARCHAR(255) DEFAULT NULL COMMENT 'Email de la persona que revisa';

-- Agregar email_jefe_rrhh
ALTER TABLE funcionarios 
ADD COLUMN email_jefe_rrhh VARCHAR(255) DEFAULT NULL COMMENT 'Email del jefe institucional de RRHH';

-- Agregar jefe_inmediato_id
ALTER TABLE funcionarios 
ADD COLUMN jefe_inmediato_id INT DEFAULT NULL COMMENT 'ID del funcionario que es su jefe inmediato';

-- Agregar rol
ALTER TABLE funcionarios 
ADD COLUMN rol VARCHAR(50) DEFAULT 'funcionario' COMMENT 'funcionario, jefe_inmediato, revisor, jefe_rrhh';
...
ADD COLUMN nivel_aprobacion_actual INT DEFAULT 1 COMMENT '1=Jefe Inmediato, 2=Revisor, 3=Jefe RRHH';

ALTER TABLE solicitudes_permiso
ADD COLUMN aprobado_jefe_inmediato TINYINT(1) DEFAULT 0;

ALTER TABLE solicitudes_permiso
ADD COLUMN nombre_jefe_inmediato VARCHAR(255) DEFAULT NULL;

ALTER TABLE solicitudes_permiso
ADD COLUMN fecha_aprobacion_jefe DATETIME DEFAULT NULL;

ALTER TABLE solicitudes_permiso
ADD COLUMN aprobado_revisor TINYINT(1) DEFAULT 0;

ALTER TABLE solicitudes_permiso
ADD COLUMN nombre_revisor VARCHAR(255) DEFAULT NULL;

ALTER TABLE solicitudes_permiso
ADD COLUMN fecha_aprobacion_revisor DATETIME DEFAULT NULL;

ALTER TABLE solicitudes_permiso
ADD COLUMN aprobado_jefe_rrhh TINYINT(1) DEFAULT 0;

ALTER TABLE solicitudes_permiso
ADD COLUMN nombre_jefe_rrhh VARCHAR(255) DEFAULT NULL;

ALTER TABLE solicitudes_permiso
ADD COLUMN fecha_aprobacion_jefe_rrhh DATETIME DEFAULT NULL;
...
ADD COLUMN nivel_aprobacion_actual INT DEFAULT 1;
